...
//  GHFollowers
//
//  Created by Muhammad Umer Farooq on 21/05/2020.
//  Copyright © 2020 Muhammad Umer Farooq. All rights reserved.
//

import UIKit

class GFUserInfoHeaderView: UIViewController {
    ...
    private func configureLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            bioLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -8)
        ])
    }
